...
public class CompleteProjectNoteHandler : IRequestHandler<CompleteProjectNoteCommand, ProjectNoteDto>
{
    ...
    public CompleteProjectNoteHandler(
    ...
    public async Task<ProjectNoteDto> Handle(CompleteProjectNoteCommand request, CancellationToken ct)
    {
        ...
        note.Status = ProjectNoteStatus.Completed;
        note.CompletedById = request.RequestingUserId;
