    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (isApiError(ex)) {
                ...
                setErr(prev => ({ ...prev, _global: (ex as any)?.message || 'Registration failed.' }));
            }
        } finally {
            setSubmitting(false);
        }
            ...
            <div className={styles?.row || ''}>
                <input
                    ...
                    onChange={e => {
                        ...
                        if (err.username)
                            setErr(prev => ({ ...prev, username: undefined }));
                    }}
            ...
            <div className={styles?.row || ''}>
                <input
                    ...
                    onChange={e => {
                        ...
                        if (err.password)
                            setErr(prev => ({ ...prev, password: undefined }));
                    }}
            ...
            <div className={styles?.row || ''}>
                <input
                    ...
                    onChange={e => {
                        ...
                        if (err.confirm)
                            setErr(prev => ({ ...prev, confirm: undefined }));
                    }}
